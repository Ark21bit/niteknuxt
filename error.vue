<template>   
    <main class="flex my-auto auto-rows-auto bg-[url(~/assets/img/bg_404.svg)] bg-no-repeat bg-right-bottom">
        <div class="flex items-center mx-auto gap-y-5 max-w-[306px] text-center flex-col md:-translate-x-1/2 mt-32">
